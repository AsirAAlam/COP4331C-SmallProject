...
function doAddContact() {
  let inputFirstname = document.getElementById(
    "firstNameInputAddContact"
  ).value;
  let inputLastname = document.getElementById("lastNameInputAddContact").value;
...
function updateContactTable(arrayOfContacts) {
  const appendContact = (contact) => {
    ...
    bodyRow.append(firstName, lastName, phone); // Append all 5 cells to the table row
